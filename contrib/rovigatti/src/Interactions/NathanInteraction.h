...
protected:
	...
	inline number _fene(BaseParticle *p, BaseParticle *q, LR_vector *r, bool update_forces);
	inline number _nonbonded(BaseParticle *p, BaseParticle *q, LR_vector *r, bool update_forces);
...
number NathanInteraction::_patchy_interaction(BaseParticle *p, BaseParticle *q, LR_vector *r, bool update_forces) {
