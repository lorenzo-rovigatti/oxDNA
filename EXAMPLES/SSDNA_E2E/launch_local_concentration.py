...
try:
	...
	print "couldn't find the script generate.py in your PYTHONPATH."
	print "You can solve the problem by typing the command:"
	print "export PYTHONPATH=$PYTHONPATH:DIR/oxdna-code/oxDNA/UTILS"
	print "where DIR is the directory where oxDNA has been installed."
	sys.exit(-1)
...
print "To change directory and run your simulation, run:"
print "cd",seq_id
print "oxDNA input"
