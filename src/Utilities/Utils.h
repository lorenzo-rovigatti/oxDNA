...
public:
	...
	static void stop_com(BaseParticle **particles, int N);
	...
	static std::vector<int> getParticlesFromString(BaseParticle **particles, int N, std::string particle_string, char const *identifier);
