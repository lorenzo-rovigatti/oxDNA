...
void DNANucleotide::set_positions() {
        ...
        if(_grooving==2) {
		float POS_MM_BACK2_new ; 
		POS_MM_BACK2_new = POS_MM_BACK2*1.05 ; 
                int_centers[BACK] = orientation * principal_axis * POS_MM_BACK1 + orientation * third_axis * POS_MM_BACK2_new;
