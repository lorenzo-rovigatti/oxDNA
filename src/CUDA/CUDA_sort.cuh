...
__global__ void permute_particles(int *sorted_hindex, int *inv_sorted_hindex, number4 *poss, number4 *vels, number4 *Ls, LR_GPU_matrix<number> *orientations, LR_bonds *bonds, number4 *buff_poss, number4 *buff_vels, number4 *buff_Ls, LR_GPU_matrix<number> *buff_orientations, LR_bonds *buff_bonds);
