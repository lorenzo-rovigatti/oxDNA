...
public:
    ...
    number rmod,rnorm;
    number damp=0;
    number patchySigma=1.0f,patchyRstar=0.9053f,patchyRc=0.99998,patchyEpsilon=2.0f,patchyLockCutOff=-0.1,patchyInteractionDistanceCutoff=0,patchyB=667.505671539,patchyRcut=1.2,patchyCutOff=10,patchyAlpha=0.10,patchyIntercept=0.0,patchySpacer=0.0; // patchyCutoff=1.8
