...
protected:
	...
	number _fene_r0_SD[5][5];
	number _fene_delta_SD[5][5]; //read from file. Average only, at the moment
	number _fene_delta2_SD[5][5];  //read from file. Average only, at the moment
	number _mbf_xmax_SD[5][5];

	Mesh _mesh_f4_SD[21][5][5];
	...
	number _f1_SD(number r, int type, int n3, int n5);
	number _f1D_SD(number r, int type, int n3, int n5);
	number _f2_SD(number r, int type, int n3, int n5);
	number _f2D_SD(number r, int type, int n3, int n5);
	number _f4_SD(number t, int type, int n3, int n5);
	number _f4D_SD(number t, int type, int n3, int n5);
	number _f4Dsin_SD(number t, int type, int n3, int n5);
...
public:
	...
	number F1_SD_A[2][5][5];
	number F1_SD_RC[2][5][5];
	number F1_SD_R0[2][5][5];
	number F1_SD_BLOW[2][5][5];
	number F1_SD_BHIGH[2][5][5];
	number F1_SD_RLOW[2][5][5];
	number F1_SD_RHIGH[2][5][5];
	number F1_SD_RCLOW[2][5][5];
	number F1_SD_RCHIGH[2][5][5];

	number F2_SD_K[4][5][5];
	number F2_SD_RC[4][5][5];
	number F2_SD_R0[4][5][5];
	number F2_SD_BLOW[4][5][5];
	number F2_SD_RLOW[4][5][5];
	number F2_SD_RCLOW[4][5][5];
	number F2_SD_BHIGH[4][5][5];
	number F2_SD_RCHIGH[4][5][5];
	number F2_SD_RHIGH[4][5][5];

	number F4_SD_THETA_A[21][5][5];
	number F4_SD_THETA_B[21][5][5];
	number F4_SD_THETA_T0[21][5][5];
	number F4_SD_THETA_TS[21][5][5];
	number F4_SD_THETA_TC[21][5][5];
	...
	number MESH_F4_SD_POINTS[21][5][5];	
