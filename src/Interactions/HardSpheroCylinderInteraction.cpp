...
void HardSpheroCylinderInteraction::allocate_particles(std::vector<BaseParticle *> &particles, int N) {
	for(int i = 0; i < N; i++)
...
void HardSpheroCylinderInteraction::check_input_sanity(std::vector<BaseParticle *> &particles, int N) {
