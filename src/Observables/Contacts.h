 ...
 * @verbatim
 ...
 [contact_distance =  (defaults to 1. A contact is defined if the centers of mass of the particles is lower than this value.)]
...
class Contacts: public BaseObservable {
private:
	// arguments
