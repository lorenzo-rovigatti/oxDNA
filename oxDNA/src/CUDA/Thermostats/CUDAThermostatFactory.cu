...
CUDABaseThermostat<number, number4> *CUDAThermostatFactory::make_thermostat(input_file &inp) {
...
template CUDABaseThermostat<float, float4> *CUDAThermostatFactory::make_thermostat<float, float4>(input_file &inp);
template CUDABaseThermostat<double, LR_double4> *CUDAThermostatFactory::make_thermostat<double, LR_double4>(input_file &inp);
