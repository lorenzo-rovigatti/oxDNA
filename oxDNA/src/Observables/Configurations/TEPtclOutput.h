...
#ifndef TEPTCLOUTPUT_H_
#define TEPTCLOUTPUT_H_

#include "../Configurations/Configuration.h"
#include "../../Particles/TEPParticle.h"

/**
 * @brief Prints a tcl configuration for TEP systems. The configuration can be loaded from the command 
...
class TEPtclOutput: public Configuration<number>  {
protected:
	bool _back_in_box;
	bool _print_labels;
...
public:
	TEPtclOutput();
	virtual ~TEPtclOutput();

	void get_settings(input_file &my_inp, input_file &sim_inp);
};

#endif /* TEPTCLOUTPUT_H_ */
