...
def init_tensors_n5(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, types_bn, hydr_r, th1, th2, th3,\
    ...
    print("Initialising FENE")

    #initialise tensors
    FENE_R_n5 = torch.tensor(fene_r, device=device)

    print("Initialising STACKING")
    ...
    print("Initialising HYDROGEN/CROSS-STACKING")
    ...
    print("Initialising DEBYE-HUCKEL")
    ...
    print("Initialising OTHERS")


    print("Initialising en offset")
