...
def init_tensors(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, ba_ba_r_bn, ba_bb_r_bn, bb_ba_r_bn, types_bn, hydr_r, th1, th2, th3,\
                  th4_unbn, th7, th8, bb_bb_r_unbn, ba_bb_r_unbn, bb_ba_r_unbn, types_unbn_33, types_unbn_55, hb_mask, shifts, OXPS_zero) :
    ...
    HB_MASK = torch.tensor(hb_mask,device=device)
...
def init_lp_angles(costb,cosot) :
...
def add_opti_par(name) :
    ...
    if vals_cn[0] == "STCK" and len(vals_cn) == 3:
        ...
        ty=fun.base_to_id(vals_cn[len(vals_cn)-4])+fun.base_to_id(vals_cn[len(vals_cn)-3])*5+fun.base_to_id(vals_cn[len(vals_cn)-2])*5*5+fun.base_to_id(vals_cn[len(vals_cn)-1])*5*5*5
...
#tensor that removes confs from analysis if any hb bond is broken
HB_CONF_MASK = None
...
def compute_initial_energy() :
    ...
    f1_m = F1(PARS_IN[par_index[45]][TYPES_BN], PARS_IN[par_index[44]][TYPES_BN], PARS_IN[par_index[45]][TYPES_BN], PARS_IN[par_index[46]][TYPES_BN], PARS_IN[par_index[48]][TYPES_BN],\
            PARS_IN[par_index[49]][TYPES_BN], PARS_IN[par_index[50]][TYPES_BN], PARS_IN[par_index[51]][TYPES_BN], PARS_IN[par_index[52]][TYPES_BN], PARS_IN[par_index[53]][TYPES_BN], SHIFT_STCK[TYPES_BN], ZEROS_BN)

    TMP = torch.abs(EN_STCK_IN) > 0.2*torch.abs(f1_m) #check whether all hbs are larger than 20% of max hb strength. If at least one is not, discard configuration
    HB_CONF_MASK_STCK = torch.all(TMP, dim=-1)
    ...
    f1_m = F1(PARS_IN[par_index[5]][TYPES_UNBN_33], PARS_IN[par_index[4]][TYPES_UNBN_33], PARS_IN[par_index[5]][TYPES_UNBN_33], PARS_IN[par_index[6]][TYPES_UNBN_33],PARS_IN[par_index[8]][TYPES_UNBN_33],\
            PARS_IN[par_index[9]][TYPES_UNBN_33], PARS_IN[par_index[10]][TYPES_UNBN_33], PARS_IN[par_index[11]][TYPES_UNBN_33], PARS_IN[par_index[12]][TYPES_UNBN_33], PARS_IN[par_index[13]][TYPES_UNBN_33], SHIFT_HYDR[TYPES_UNBN_33], ZEROS_UNBN)

    """
    f4_th1_m = F4(PARS_IN[par_index[14]][TYPES_UNBN_33],PARS_IN[par_index[14]][TYPES_UNBN_33],PARS_IN[par_index[15]][TYPES_UNBN_33],PARS_IN[par_index[16]][TYPES_UNBN_33],\
                PARS_IN[par_index[17]][TYPES_UNBN_33],PARS_IN[par_index[18]][TYPES_UNBN_33],ZEROS_UNBN)

    f4_th2_m = F4(PARS_IN[par_index[19]][TYPES_UNBN_33],PARS_IN[par_index[19]][TYPES_UNBN_33],PARS_IN[par_index[20]][TYPES_UNBN_33],PARS_IN[par_index[21]][TYPES_UNBN_33],\
                PARS_IN[par_index[22]][TYPES_UNBN_33],PARS_IN[par_index[23]][TYPES_UNBN_33],ZEROS_UNBN)

    f4_th3_m = F4(PARS_IN[par_index[24]][TYPES_UNBN_33],PARS_IN[par_index[24]][TYPES_UNBN_33],PARS_IN[par_index[25]][TYPES_UNBN_33],PARS_IN[par_index[26]][TYPES_UNBN_33],\
                PARS_IN[par_index[27]][TYPES_UNBN_33],PARS_IN[par_index[28]][TYPES_UNBN_33],ZEROS_UNBN)

    f4_th4_m = F4(PARS_IN[par_index[29]][TYPES_UNBN_33],PARS_IN[par_index[29]][TYPES_UNBN_33],PARS_IN[par_index[30]][TYPES_UNBN_33],PARS_IN[par_index[31]][TYPES_UNBN_33],\
                PARS_IN[par_index[32]][TYPES_UNBN_33],PARS_IN[par_index[33]][TYPES_UNBN_33],ZEROS_UNBN)

    f4_th7_m = F4(PARS_IN[par_index[34]][TYPES_UNBN_33],PARS_IN[par_index[34]][TYPES_UNBN_33],PARS_IN[par_index[35]][TYPES_UNBN_33],PARS_IN[par_index[36]][TYPES_UNBN_33],\
                PARS_IN[par_index[37]][TYPES_UNBN_33],PARS_IN[par_index[38]][TYPES_UNBN_33],ZEROS_UNBN)

    f4_th8_m = F4(PARS_IN[par_index[39]][TYPES_UNBN_33],PARS_IN[par_index[39]][TYPES_UNBN_33],PARS_IN[par_index[40]][TYPES_UNBN_33],PARS_IN[par_index[41]][TYPES_UNBN_33],\
                PARS_IN[par_index[42]][TYPES_UNBN_33],PARS_IN[par_index[43]][TYPES_UNBN_33],ZEROS_UNBN)
    """
    ...
    print(HB_MASK[5][2])
    print("EN_HYDR")
    print(torch.abs(EN_HYDR_IN[5][2]))
    print("cutoff")
    print(0.2*torch.abs(f1_m)[5][2])
    """
    TMP = (HB_MASK > 0) & (torch.abs(EN_HYDR_IN) > 0.1*torch.abs(f1_m)) #check whether all hbs are larger than 20% of max hb strength. If at least one is not, discard configuration
    HB_CONF_MASK = torch.all(HB_MASK == TMP, dim=-1) #true if configuration is valid
    #HB_CONF_MASK = HB_CONF_MASK & HB_CONF_MASK_STCK    #use this if we want to screen unstacked confs
    HB_CONF_MASK = HB_CONF_MASK & HB_CONF_MASK_FENE

    #print("conf mask")
    #print(HB_CONF_MASK[5])
...
def compute_rew_factor(PARS,SH_ST) :
    ...
    f2_33 = F2(HYDR_R, PARS[par_index[77]][TYPES_UNBN_33], PARS[par_index[78]][TYPES_UNBN_33], PARS[par_index[79]][TYPES_UNBN_33], PARS[par_index[80]][TYPES_UNBN_33], PARS[par_index[81]][TYPES_UNBN_33],\
    ...
    f4_th4_33 = F4(TH4_UNBN,PARS[par_index[101]][TYPES_UNBN_33],PARS[par_index[102]][TYPES_UNBN_33],PARS[par_index[103]][TYPES_UNBN_33],\
                PARS[par_index[104]][TYPES_UNBN_33],PARS[par_index[105]][TYPES_UNBN_33],ZEROS_UNBN)

    CRST_33_MOD_REW = f2_33*f4_th4_33


    f2_55 = F2(HYDR_R, PARS[par_index[116]][TYPES_UNBN_55], PARS[par_index[117]][TYPES_UNBN_55], PARS[par_index[118]][TYPES_UNBN_55], PARS[par_index[119]][TYPES_UNBN_55], PARS[par_index[120]][TYPES_UNBN_55],\
    ...
    f4_th4_55 = F4(TH4_UNBN,PARS[par_index[140]][TYPES_UNBN_55],PARS[par_index[141]][TYPES_UNBN_55],PARS[par_index[142]][TYPES_UNBN_55],\
...
def COST(PARS) :
    ...
    CURR_REW_MU = torch.clone(REW_MU)
