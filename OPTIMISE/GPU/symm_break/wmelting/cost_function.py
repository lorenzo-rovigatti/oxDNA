...
#initailise tensors with coordinates and
def init_tensors_melting_n5(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, types_bn, hydr_r, th1, th2, th3,\
                  th4_unbn, th7, th8, types_unbn_33, types_unbn_55, mTs, offset, ent) :
...
#initailise tensors with coordinates and
def init_tensors_melting_n8(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, types_bn, hydr_r, th1, th2, th3,\
                  th4_unbn, th7, th8, types_unbn_33, types_unbn_55, mTs, offset, ent) :
...
#initailise tensors with coordinates and
def init_tensors_melting_n15(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, types_bn, hydr_r, th1, th2, th3,\
                  th4_unbn, th7, th8, types_unbn_33, types_unbn_55, mTs, offset, ent) :
...
def COST_m(PARS) :
    ...
    EN_PER_NUCLEO = (((EN_FENE_IN_m_n8+EN_STCK_m_n8).sum(dim=2) + (EN_HYDR_m_n8+EN_CRST_33_m_n8+EN_CRST_55_m_n8).sum(dim=2))/16.).sum(dim=1)/dy + EN_OFFSET_m_n8
    ...
    EN_PER_NUCLEO = (((EN_FENE_IN_m_n15+EN_STCK_m_n15).sum(dim=2) + (EN_HYDR_m_n15+EN_CRST_33_m_n15+EN_CRST_55_m_n15).sum(dim=2))/30.).sum(dim=1)/dy + EN_OFFSET_m_n15
