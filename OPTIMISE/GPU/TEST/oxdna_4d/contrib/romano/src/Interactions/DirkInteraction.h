...
extern "C" BaseInteraction<float> * make_float() { return new DirkInteraction<float>(); }
extern "C" BaseInteraction<double> * make_double() { return new DirkInteraction<double>(); }
