...
EN_STCK_IN_n5 = None
STCK_MOD_IN_n5 = None
STCK_MOD_FIX_n5 = None
EN_HYDR_IN_n5 = None
HYDR_MOD_IN_n5 = None
HYDR_MOD_FIX_n5 = None
EN_CRST_33_IN_n5 = None
CRST_33_MOD_IN_n5 = None
CRST_33_MOD_FIX_n5 = None
EN_CRST_55_IN_n5 = None
CRST_55_MOD_IN_n5 = None
CRST_55_MOD_FIX_n5 = None
...
def init_tensors_n5(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, types_bn, hydr_r, th1, th2, th3,\
    ...
    ZEROS_BN_n5 = torch.zeros(len(types_bn),len(types_bn[0]),len(types_bn[0][0]),device=device)
    ONES_BN_n5 = torch.ones(len(types_bn),len(types_bn[0]),len(types_bn[0][0]),device=device)
    ZEROS_UNBN_n5 = torch.zeros(len(types_unbn_33),len(types_unbn_33[0]),len(types_unbn_33[0][0]),device=device)
...
EN_STCK_IN_n8 = None
STCK_MOD_IN_n8 = None
STCK_MOD_FIX_n8 = None
EN_HYDR_IN_n8 = None
HYDR_MOD_IN_n8 = None
HYDR_MOD_FIX_n8 = None
EN_CRST_33_IN_n8 = None
CRST_33_MOD_IN_n8 = None
CRST_33_MOD_FIX_n8 = None
EN_CRST_55_IN_n8 = None
CRST_55_MOD_IN_n8 = None
CRST_55_MOD_FIX_n8 = None
...
def init_tensors_n8(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, types_bn, hydr_r, th1, th2, th3,\
    ...
    ZEROS_BN_n8 = torch.zeros(len(types_bn),len(types_bn[0]),len(types_bn[0][0]),device=device)
    ONES_BN_n8 = torch.ones(len(types_bn),len(types_bn[0]),len(types_bn[0][0]),device=device)
    ZEROS_UNBN_n8 = torch.zeros(len(types_unbn_33),len(types_unbn_33[0]),len(types_unbn_33[0][0]),device=device)
...
EN_FENE_IN_n15 = None
EN_STCK_IN_n15 = None
STCK_MOD_IN_n15 = None
STCK_MOD_FIX_n15 = None
EN_HYDR_IN_n15 = None
HYDR_MOD_IN_n15 = None
HYDR_MOD_FIX_n15 = None
EN_CRST_33_IN_n15 = None
CRST_33_MOD_IN_n15 = None
CRST_33_MOD_FIX_n15 = None
EN_CRST_55_IN_n15 = None
CRST_55_MOD_IN_n15 = None
CRST_55_MOD_FIX_n15 = None
...
def init_tensors_n15(dev, fene_r, stck_r, th4_bn, th5, th6, cosphi1, cosphi2, types_bn, hydr_r, th1, th2, th3,\
    ...
    ZEROS_BN_n15 = torch.zeros(len(types_bn),len(types_bn[0]),len(types_bn[0][0]),device=device)
    ONES_BN_n15 = torch.ones(len(types_bn),len(types_bn[0]),len(types_bn[0][0]),device=device)
    ZEROS_UNBN_n15 = torch.zeros(len(types_unbn_33),len(types_unbn_33[0]),len(types_unbn_33[0][0]),device=device)
...
def compute_energy_n5() :
    ...
    f1 = F1(STCK_R_n5, CURR_PARS[par_index[44]][TYPES_BN_n5], CURR_PARS[par_index[45]][TYPES_BN_n5], CURR_PARS[par_index[46]][TYPES_BN_n5], CURR_PARS[par_index[48]][TYPES_BN_n5],\
            CURR_PARS[par_index[49]][TYPES_BN_n5], CURR_PARS[par_index[50]][TYPES_BN_n5], CURR_PARS[par_index[51]][TYPES_BN_n5], CURR_PARS[par_index[52]][TYPES_BN_n5], CURR_PARS[par_index[53]][TYPES_BN_n5], CURR_SHIFT_ST[TYPES_BN_n5], ZEROS_BN_n5)
    ...
    f1 = F1(HYDR_R_n5, CURR_PARS[par_index[4]][TYPES_UNBN_33_n5], CURR_PARS[par_index[5]][TYPES_UNBN_33_n5], CURR_PARS[par_index[6]][TYPES_UNBN_33_n5],CURR_PARS[par_index[8]][TYPES_UNBN_33_n5],\
            CURR_PARS[par_index[9]][TYPES_UNBN_33_n5], CURR_PARS[par_index[10]][TYPES_UNBN_33_n5], CURR_PARS[par_index[11]][TYPES_UNBN_33_n5], CURR_PARS[par_index[12]][TYPES_UNBN_33_n5], CURR_PARS[par_index[13]][TYPES_UNBN_33_n5], CURR_SHIFT_HY[TYPES_UNBN_33_n5], ZEROS_UNBN_n5)
...
def compute_energy_n8() :
    ...
    f1 = F1(STCK_R_n8, CURR_PARS[par_index[44]][TYPES_BN_n8], CURR_PARS[par_index[45]][TYPES_BN_n8], CURR_PARS[par_index[46]][TYPES_BN_n8], CURR_PARS[par_index[48]][TYPES_BN_n8],\
            CURR_PARS[par_index[49]][TYPES_BN_n8], CURR_PARS[par_index[50]][TYPES_BN_n8], CURR_PARS[par_index[51]][TYPES_BN_n8], CURR_PARS[par_index[52]][TYPES_BN_n8], CURR_PARS[par_index[53]][TYPES_BN_n8], CURR_SHIFT_ST[TYPES_BN_n8], ZEROS_BN_n8)
    ...
    f1 = F1(HYDR_R_n8, CURR_PARS[par_index[4]][TYPES_UNBN_33_n8], CURR_PARS[par_index[5]][TYPES_UNBN_33_n8], CURR_PARS[par_index[6]][TYPES_UNBN_33_n8],CURR_PARS[par_index[8]][TYPES_UNBN_33_n8],\
            CURR_PARS[par_index[9]][TYPES_UNBN_33_n8], CURR_PARS[par_index[10]][TYPES_UNBN_33_n8], CURR_PARS[par_index[11]][TYPES_UNBN_33_n8], CURR_PARS[par_index[12]][TYPES_UNBN_33_n8], CURR_PARS[par_index[13]][TYPES_UNBN_33_n8], CURR_SHIFT_HY[TYPES_UNBN_33_n8], ZEROS_UNBN_n8)
...
def compute_initial_energy_n15() :
    ...
    f1 = F1(STCK_R_n15, CURR_PARS[par_index[44]][TYPES_BN_n15], CURR_PARS[par_index[45]][TYPES_BN_n15], CURR_PARS[par_index[46]][TYPES_BN_n15], CURR_PARS[par_index[48]][TYPES_BN_n15],\
            CURR_PARS[par_index[49]][TYPES_BN_n15], CURR_PARS[par_index[50]][TYPES_BN_n15], CURR_PARS[par_index[51]][TYPES_BN_n15], CURR_PARS[par_index[52]][TYPES_BN_n15], CURR_PARS[par_index[53]][TYPES_BN_n15], CURR_SHIFT_ST[TYPES_BN_n15], ZEROS_BN_n15)
    ...
    f1 = F1(HYDR_R_n15, CURR_PARS[par_index[4]][TYPES_UNBN_33_n15], CURR_PARS[par_index[5]][TYPES_UNBN_33_n15], CURR_PARS[par_index[6]][TYPES_UNBN_33_n15],CURR_PARS[par_index[8]][TYPES_UNBN_33_n15],\
            CURR_PARS[par_index[9]][TYPES_UNBN_33_n15], CURR_PARS[par_index[10]][TYPES_UNBN_33_n15], CURR_PARS[par_index[11]][TYPES_UNBN_33_n15], CURR_PARS[par_index[12]][TYPES_UNBN_33_n15], CURR_PARS[par_index[13]][TYPES_UNBN_33_n15], CURR_SHIFT_HY[TYPES_UNBN_33_n15], ZEROS_UNBN_n15)
...
def compute_rew_energy_n5(PARS) :
    ...
    EN_HYDR_REW_n5 = EN_HYDR_IN_n5*PARS[par_index[4]][TYPES_UNBN_33_n5]/PARS_IN[par_index[4]][TYPES_UNBN_33_n5]
...
def update_rew_Ts(update_flag):
    ...
    if update_flag:       
        ...
        for l in range(cg.seq_n5) :
            T0 = cg.current_mT_n5[l]
            ...
            for k in range(lrs_n5[l],urs_n5[l]) :
                ...
                REW_Ts_n5[l][counts] = D_Ts_n5[l]*k+T0 + offset
                counts += 1
                
        for l in range(cg.seq_n8) :
            T0 = cg.current_mT_n8[l]
            ...
            for k in range(lrs_n8[l],urs_n8[l]) :
                ...
                REW_Ts_n8[l][counts] = D_Ts_n8[l]*k+T0 + offset
                counts += 1
                
        for l in range(cg.seq_n15) :
            T0 = cg.current_mT_n15[l]
            ...
            for k in range(lrs_n15[l],urs_n15[l]) :
                ...
                REW_Ts_n15[l][counts] = D_Ts_n15[l]*k+T0 + offset
                counts += 1
...
def estimate_mT(Ts,HISTS) :
    ...
    MAX_V, MAX_ID = torch.max(HISTS_REW,dim=2)
    N_HISTS = torch.einsum('ijk,ij->ijk', HISTS_REW, 1/MAX_V)
    RATIO = N_HISTS[:,:,1:].sum(dim=2)/N_HISTS[:,:,0]

    UP_V,UP_ID = torch.min(torch.where(RATIO>=0.5,RATIO,10),dim=1)
    LOW_V,LOW_ID = torch.max(torch.where(RATIO<0.5,RATIO,-10),dim=1)
    
    mTs = Ts[:,LOW_ID] + (Ts[:,UP_ID]-Ts[:,LOW_ID])/(RATIO[:,UP_ID]-RATIO[:,LOW_ID])*(0.5-RATIO[:,LOW_ID])
...
def COST(PARS) :
    ...
    REW_WEIGHTS = -torch.einsum('i,ij->ij',1/SIM_Ts_n5,torch.sum(EN_HYDR_IN_n5+EN_CRST_33_IN_n5+EN_CRST_55_IN_n5,dim=2)+torch.sum(EN_FENE_IN_n5,dim=2)+EN_OFFSET_n5).repeat(s2) \
         +torch.einsum('ik,ij->ijk',1/REW_Ts,torch.sum(EN_HYDR_REW_n5+EN_CRST_33_REW_n5+EN_CRST_55_REW_n5,dim=2)++torch.sum(EN_FENE_IN_n5,dim=2)+EN_OFFSET_n5)
    REW_WEIGHTS += -torch.einsum('i,ij->ij',1/SIM_Ts_n5,torch.sum(EN_STCK_IN_n5,dim=2)).repeat(s2) \
         +torch.einsum('ik,ij->ijk',DELTA,EN_STCK_REW_n5.sum(dim=2))
    ...
    REW_WEIGHTS = -torch.einsum('i,ij->ij',1/SIM_Ts_n8,torch.sum(EN_HYDR_IN_n8+EN_CRST_33_IN_n8+EN_CRST_55_IN_n8,dim=2)+torch.sum(EN_FENE_IN_n8,dim=2)+EN_OFFSET_n8).repeat(s2) \
         +torch.einsum('ik,ij->ijk',1/REW_Ts,torch.sum(EN_HYDR_REW_n8+EN_CRST_33_REW_n8+EN_CRST_55_REW_n8,dim=2)++torch.sum(EN_FENE_IN_n8,dim=2)+EN_OFFSET_n8)
    ...
    mTs_n8 = estimate_mT(REW_Ts_n8,HISTS_REW)
    ...
    REW_WEIGHTS = -torch.einsum('i,ij->ij',1/SIM_Ts_n15,torch.sum(EN_HYDR_IN_n15+EN_CRST_33_IN_n15+EN_CRST_55_IN_n15,dim=2)+torch.sum(EN_FENE_IN_n15,dim=2)+EN_OFFSET_n15).repeat(s2) \
         +torch.einsum('ik,ij->ijk',1/REW_Ts,torch.sum(EN_HYDR_REW_n15+EN_CRST_33_REW_n15+EN_CRST_55_REW_n15,dim=2)++torch.sum(EN_FENE_IN_n15,dim=2)+EN_OFFSET_n15)
    ...
    mTs_n15 = estimate_mT(REW_Ts_n15,HISTS_REW)
