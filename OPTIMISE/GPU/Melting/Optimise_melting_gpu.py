...
for l in range(cg.Nseq_n5):
    ...
    cfun.hbs_sampled_n5.append(hbs_1)
...
for l in range(cg.Nseq_n8):
    ...
    cfun.hbs_sampled_n8.append(hbs_1)
...
for l in range(cg.Nseq_n15):
    ...
    cfun.hbs_sampled_n15.append(hbs_1)
...
cfun.compute_initial_energy_n5()
cfun.compute_initial_energy_n8()
cfun.compute_initial_energy_n15()

print("Computed initial energy")

tfile = open("fene_in_n5.txt", 'w')

EN = cfun.EN_FENE_IN_n5.sum(dim=2)/10
...
tfile = open("stck_in_n5.txt", 'w')

EN = cfun.EN_STCK_IN_n5.sum(dim=2)/10
...
tfile = open("hydr_in_n5.txt", 'w')

EN = cfun.EN_HYDR_IN_n5.sum(dim=2)/10
...
tfile = open("crst_in_n5.txt", 'w')

EN = (cfun.EN_CRST_33_IN_n5+cfun.EN_CRST_55_IN_n5).sum(dim=2)/10
