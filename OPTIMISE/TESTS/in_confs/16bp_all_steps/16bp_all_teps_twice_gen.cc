...
//create a sequence of 33 basepairs such that all 16 bp steps. The order of the steps is random.
...
seed = atoi(argv[1]);
cout << "Generating 16 bps (symmetry not accounted for) double helix with all steps twice." << endl;
