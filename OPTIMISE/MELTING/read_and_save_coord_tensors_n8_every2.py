...
def read_n8_seq(id) :
    ...
    for rp in range(N_pts) :
        for m in range(cg.Nreps) :
            ...
            fr, sr, t4bn, t5, t6, cp1, cp2, tbn, hr, t1, t2, t3, t4un, t7, t8, tun33, tun55, dh_r, dh_ty, dh_chcut = fun.read_oxdna_trajectory_dist_and_angles_every(rclow, rchigh, rcut_dh_n8[l], tr_file, topo_file, cg.boxes_n8[l],2)
