        ...
        if(vals[0] == 'SEQ'):
            ...
            if nbp == 5:
                ...
                #w parallel tempering!
                    ...
                    npars += 1
                    DT = float(vals[npars])
                    NT = int((12+sTs[len(sTs)-1]-sTs[0])/DT+1)
...
def read_oxdna_trajectory_dist_and_angles(rcut_low, rcut_high, rcut_dh, tr_file, topo_file, box, _print=False):
                ...
                if len(config) == Nb :
                    ...
                    for i in range(len(topology)) :
                        ...
                        for j in range(len(topology)) :
                            ...
                            #if counts == 10 and _print:
                            #    print("pair", topology[i].id, topology[j].id,n1.c,n2.c,min_im_v)

                            if bbdist > rcut_dh and rcut_dh > rcut_high:
                                if counts == 10 and _print: print("out of dh range", bbdist)
                                continue #if we are out of debye huckle range
                            if hydist2 < rcut_sq_low:
                                if counts == 10 and _print: print("coff low", hydist2)
                                out_of_range = True #verlet cutoff
                            if hydist2 > rcut_sq_high:
                                if counts == 10 and _print: print("coff high", hydist2)
                                out_of_range = True #verlet cutoff
                            ...
                            if counts == 10 and _print:
                                print("in range pair", topology[i].id, topology[j].id)
...
def read_oxdna_trajectory_dist_and_angles_every(rcut_low, rcut_high, rcut_dh, tr_file, topo_file, box, every, _print=False):
