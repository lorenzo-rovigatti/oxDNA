...
def compute_rew_energy_n15(PARS) :
    ...
    EN_STCK_REW_n15 = EN_STCK_IN_n15*PARS[par_index[44]][TYPES_BN_n15]/PARS_IN[par_index[44]][TYPES_BN_n15]*(1.0 - cg.stck_fact_eps + (0.1 * 9.0 * cg.stck_fact_eps))
