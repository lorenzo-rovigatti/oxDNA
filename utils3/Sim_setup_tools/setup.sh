...
template_path="home/andrea/oxDNA/Sim_setup_tools" #template folder path
sim_path="/home/andrea/Desktop/oxDNA3_explo_analysis/prova" #where the simulation folder is created

Nseqs=2 #number of simulated sequences
Nreps=2 #number of repetitions for each sequence
...
declare -a input_script=("input_MD" "input_MD") #see template/oxdna_input_scripts. seed updated and set to random
#Each sequence has its personalised input script (e.g. VMMC or MD)

declare -a umbrella=(0 0) #1 if umbrella is active. If umbrella==1, copy order parameter and weights and update input accordingly
declare -a op_file=("" "")
declare -a w_file=("" "")

declare -a input_conf_method=("dangling_extra_base" "random_mismatched_bp")  #Each sequence is generated in the specified way. Array of length Nseqs. See template/in_confs/${input_conf_method[$i]}
declare -a NgenPar=(2 2) #number of parameters of the specified method
...
gen_parNames[0,1]="Nbp"
gen_parNames[1,0]="BOX_SIZE"
gen_parNames[1,1]="Nbp"
declare -A gen_parVals #values of the parameters
gen_parVals[0,0]="50."
gen_parVals[0,1]="12"
#gen_parVals[0,1]="double_GCGGGATTACGCAGCGC.txt"
gen_parVals[1,0]="50."
gen_parVals[1,1]="12"

#strating oxdna version (path to folder)
oxdna_path="home/andrea/oxDNA/oxdna"
oxdna_version="oxdna2"
