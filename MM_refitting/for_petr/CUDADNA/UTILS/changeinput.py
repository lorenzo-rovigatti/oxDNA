...
input_options = ['T','sym_type','dt', 'steps', 'conf_file', 'topology', 'delta_translation', 'seed', 'lambda_or', 'lambda_tr', 'maxclust', 'restart_step_counter', 'init_hist_file', 'verlet_skin']
...
for file in files:
    ...
    inp.close ()
    out.close ()
    shutil.copyfile('.' + file + '_new', file)
