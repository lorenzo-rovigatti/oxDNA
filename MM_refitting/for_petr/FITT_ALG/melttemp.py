...
def get_TM(seq,boxsize=20,salt_conc=0.5):
  ...
  salt_correction = 0.368 * (len(seq) -1 )  * math.log(salt_conc)
...
if len(sys.argv) < 3:
	print "Usage: ./sek sek salt box=20"
	sys.exit(1)
...
print sek, get_complementary(sek), 273.15+get_TM(sek,box,float(salt))
