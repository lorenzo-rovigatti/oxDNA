...
echo =========================================================   
echo PBS job: submitted  date = Thu Jul  3 00:39:56 BST 2014      
date_start=`date +%s`
echo 1 cpus on 1 nodes \( SMP=1 \)        
#echo Executable file: /usersVol2/sulc/MM_refitting/for_petr/FITT_ALG/SRC_TWO/singletest                             
#echo $PBS_NODEFILE
#cat $PBS_NODEFILE
#ls -l $PBS_NODEFILE
echo 1 hosts used:                                 
...
echo -----------------                                           
echo   
/usersVol2/sulc/MM_refitting/for_petr/FITT_ALG/SRC_TWO/singletest VELKYTEST new_rescaled.txt H 1 1 VELKY
echo   
echo ---------------                                           
